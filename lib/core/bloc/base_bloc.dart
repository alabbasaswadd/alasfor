...
abstract class BaseBloc<E extends BaseEvent, S> extends Bloc<E, S> {
  ...
  void handleError(Object error, StackTrace stackTrace) {
    showErrorSnackBar(errorMessageForBloc(error));
  }

  String errorMessageForBloc(Object error) {
  ...
  Future<void> safeEmit<T>({
    ...
    required S Function(T result) successState,
